...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        final File factsDirectory = new File(projectDirectory + args[1]);
        ...
        File rulesFile = new File(projectDirectory + args[2] +"/rules.iris");
        Reader rulesReader = new FileReader(rulesFile);

        File queriesFile = new File(projectDirectory + args[3] + "/queries.iris");
